...
data_multivocal = data_multivocal.loc[
    ~data_multivocal["liasse_numero"].isin(data_multivocal_ground_truth["liasse_numero"].tolist())
]
...
data_multivocal = data_multivocal.merge(data_sirene4, on="liasse_numero", how="left")
data_multivocal_ground_truth = data_multivocal_ground_truth.merge(
...
data_multivocal_ground_truth = data_multivocal_ground_truth.drop_duplicates(
...
data_multivocal_resampled = (
    data_multivocal.merge(
...
data_multivocal_ground_truth_resampled = (
    data_multivocal_ground_truth.merge(
        data_sirene4_multivoque, on=[v for v in VAR_TO_KEEP if v != "liasse_numero"], how="left"
    )
    .rename(columns={"liasse_numero_y": "liasse_numero"})
    .drop(columns=["liasse_numero_x"])
...
data_multivocal_ground_truth_resampled.dropna(subset=["liasse_numero"], inplace=True)

data_sirene4_nace2025 = pd.concat(
    [data_univocal, data_multivocal_resampled, data_multivocal_ground_truth_resampled], axis=0
)
